...
if game.Players.LocalPlayer.UserId == 3233318434 then
--------------------    ----------------------------------------------------------------------
...
function play(ID, STOP, LMAO)
    if lp.Backpack:FindFirstChild("[Boombox]") then
        ...
        if STOP == true then
            ...
            local cor = coroutine.wrap(function()
                repeat wait() until lp.Character.LowerTorso.BOOMBOXSOUND.SoundId == "rbxassetid://"..ID and lp.Character.LowerTorso.BOOMBOXSOUND.TimeLength > 0.00001
...
------------------------------------------------------------------------------------------
for i,f in pairs(game:GetService("Players").LocalPlayer.Character.Head:GetChildren()) do
...
pcall(function()
local ow = game:GetService("Players")["IIlIllIlIlIllIIlIIlI"]
...
lp.Chatted:connect(function(b)
local Target = GetPlayer(b:match("/e b %s*(.+)"))
if not Target then return end
if starplat == true then
wait(0.85)
play(5162851723, true, true)
...
speaking = false
    ...
    if msg == "Why did you just call me jojo?" and speaking == false then
speaking = true
...
speaking = false
    ...
    if msg == "Ally or enemy? It's your choice." and speaking == false then
speaking = true
play(8825179323, true, true)
wait(3.413)
speaking = false
end
    if msg == "Nice, Nice.." and speaking == false then
speaking = true
play(8825592240, true, true)
wait(1.511)
speaking = false
end
